...
def code_verify
  ...
  def user_params
    ...
    params.require(:user).permit(:email_code, :username, :password, :email, :img, :user_type, :phone_number, :address, :release_date, :manager, :employment_date, :employment_type, :employed, :work_hours, :residence, :meeting)
  end
